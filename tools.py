...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.CardWidget_3.setFixedHeight(100)
        self.cpu_occupied_label = StrongBodyLabel(self.CardWidget_3)
        self.mem_occupied_label = StrongBodyLabel(self.CardWidget_3)
        self.cpu_occupied = ProgressRing(self.CardWidget_3)
        self.mem_occupied = ProgressRing(self.CardWidget_3)
        self.cpu_occupied.setValue(0)
        self.cpu_occupied.setTextVisible(True)
        self.cpu_occupied.setFixedSize(80, 80)
        self.mem_occupied.setValue(0)
        self.mem_occupied.setTextVisible(True)
        self.mem_occupied.setFixedSize(80, 80)

        layout = QHBoxLayout(Form)
        self.CardWidget.setFixedWidth(500)
        subLayout_1 = QVBoxLayout(self.CardWidget)
        subLayout_1_1 = QFormLayout()
        subLayout_1_1 .setContentsMargins(5, 10, 10,5)
        subLayout_1_1 .addRow(self.StrongBodyLabel, self.model)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_17, self.product)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_2, self.brand)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1.addRow(self.StrongBodyLabel_3, self.android_version)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_8, self.sn)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_9, self.mac)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_16, self.wlanMac)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_6, self.fingerprint)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_7, self.ipv4)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1.addRow(self.StrongBodyLabel_4, self.sw)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.StrongBodyLabel_5, self.hw)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))
        subLayout_1_1 .addRow(self.search_prop, self.output_prop)
        subLayout_1_1 .addItem(QSpacerItem(10, 1, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding))


        hsubLayout_1_2 = QHBoxLayout()
        hsubLayout_1_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))
        hsubLayout_1_2.addWidget(self.button_cmd)
        hsubLayout_1_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))
        hsubLayout_1_2.addWidget(self.button_sign)
        hsubLayout_1_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))
        hsubLayout_1_2.addWidget(self.button_refresh)
        hsubLayout_1_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))

        subLayout_1.addLayout(subLayout_1_1)
        subLayout_1.addLayout(hsubLayout_1_2)
        layout.addWidget(self.CardWidget,1)

        subLayout_2 = QVBoxLayout()
        subLayout_2_1 = QFormLayout(self.CardWidget_2)
        subLayout_2_1.addRow(self.StrongBodyLabel_10, self.show_1)
        subLayout_2_1.addRow(self.StrongBodyLabel_11, self.show_2)
        subLayout_2_1.addRow(self.StrongBodyLabel_12, self.show_3)
        subLayout_2_1.addRow(self.StrongBodyLabel_13, self.show_4)
        subLayout_2_1.addRow(self.StrongBodyLabel_14, self.show_5)
        subLayout_2_1.addRow(self.StrongBodyLabel_15, self.show_6)

        subLayout_2_2 = QHBoxLayout(self.CardWidget_3)
        subLayout_2_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))
        subLayout_2_2.addWidget(self.cpu_occupied_label)
        subLayout_2_2.addWidget(self.cpu_occupied)
        subLayout_2_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))
        subLayout_2_2.addWidget(self.mem_occupied_label)
        subLayout_2_2.addWidget(self.mem_occupied)
        subLayout_2_2.addItem(QSpacerItem(1, 1, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))

        subLayout_2.addWidget(self.CardWidget_3)
        subLayout_2.addWidget(self.CardWidget_2)

        layout.addLayout(subLayout_2,1)
    ...
    def retranslateUi(self, Form):
        ...
        self.cpu_occupied_label.setText(_translate("Form", "CPU占用率"))
        self.mem_occupied_label.setText(_translate("Form", "内存占用率"))
