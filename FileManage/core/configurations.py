...
from FileManage.data.models import Device
from FileManage.helpers.tools import Singleton, json_to_dict
...
class Settings(metaclass=Singleton):
    ...
    filename = resource_filename('FileManage', 'settings.json')
    data = None
